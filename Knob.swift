...
public class Knob: UIControl {
    ...
    func createSublayers() {
        ...
        knobRenderer.strokeColor = tintColor
        knobRenderer.startAngle = CGFloat(0)
        knobRenderer.endAngle = CGFloat(2 * M_PI)
...
private class KnobRenderer {
    ...
    func updatePointerLayerPath() {
        ...
        path.addLineToPoint(CGPoint(x: pointerLayer.bounds.width - (3*pointerLength) - pointerLayer.lineWidth / 2.0, y: pointerLayer.bounds.height / 2.0))
